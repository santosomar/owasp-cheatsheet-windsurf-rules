...
id: secure-xml-processing
name: Secure XML Processing and Validation
description: |
...
severity: high
tags: [security, xml, validation, xxe, dos, ssrf]

rules:
  - message: "Use a standards-compliant XML parser configured to disable DTD processing and external entity resolution to prevent XXE and entity expansion attacks."
    pattern: |
  ...
  - message: "Validate all XML documents strictly against local, trusted XML Schemas (XSDs) with narrow data type restrictions and clearly defined element occurrence limits."
    pattern: |
  ...
  - message: "Prevent resource exhaustion by rejecting XML documents with excessive depth, nested unclosed tags, or large size to avoid DoS."
    pattern: |
  ...
  - message: "Block or sandbox XML processing from making remote network calls to mitigate SSRF and information disclosure risks."
    pattern: |
  ...
  - message: "Log and monitor XML parsing errors and rejections to detect injection attempts, malformed XML attacks, or schema poisoning."
    pattern: |
